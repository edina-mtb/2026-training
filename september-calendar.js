...
const septemberTrainingDays = [
  ...
  { day: 7, focus: 'Recovery + strength', detail: 'Start Race 3 week with less fatigue, not more.', tone: 'strength' },
  ...
  { day: 21, focus: 'Recovery + strength', detail: 'Mobility and light durability work only.', tone: 'strength' },
