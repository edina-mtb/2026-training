...
const octoberTrainingDays = [
  ...
  { day: 5, focus: 'Strength maintenance', detail: 'Mobility and activation only. No heavy fatigue. <a class="calendar-day__focus-link" href="./strength-guide.html">Strength guide</a>.', tone: 'strength' },
